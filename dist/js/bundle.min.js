...
})})}(jQuery),$(document).ready(function(){function t(t,i){var n,s;n=t-i,$("#flashcard-result").html(n),0===n&&($("#audio-win-v3")[0].play(),$("#header-score").effect("bounce",{times:10},"slow").addClass("winning"),e(100),s="Holy amazeballs!!! You win!!"),(n>0&&n<=10||n<0&&n>=-10)&&($("#audio-win-v1")[0].play(),e(5),s="Are you secretly a ninja?!"),(n>=11&&n<=20||n<-11&&n>=-20)&&(e(3),s="Superman wants his reflexes back!"),(n>=21&&n<=30||n<-21&&n>=-30)&&(e(1),s="How many redbulls have you had!"),(n>=31&&n<=50||n<-31&&n>=-50)&&(s="oooohhh sooo close!"),(n>=51&&n<=150||n<-51&&n>=-150)&&(e(-2),s="ouch...nearly there!"),(n>=151&&n<=250||n<-151&&n>=-250)&&(e(-5),s="Not bad...not great..but not bad"),(n>=251&&n<=500||n<-250&&n>=-500)&&(e(-10),$("#audio-pop")[0].play(),s="Mmm - you might need some more practice..."),(n>=501&&n<=1e3||n<-501&&n>=-1e3)&&(e(-15),$("#audio-close")[0].play(),s="My grandma has better reflexes! And she's dead!"),(n>1001||n<-1001)&&($("#audio-wasted")[0].play(),e(-25),s="I think your phone might be broken..."),$("#score-reaction").text(s)}function e(t){s+=t,$("#score").html(s)}$("#audio-warm-synth")[0].play();var i=!1,n=0,s=0,o=1e3,a=$('<img src="dist/images/rolling.svg"/>');$("#action-button").on("click",function(){if(i){i=!1,end=(new Date).getTime(),n=end-start,t(n,o);var e=n>1e3?"s":"ms";$("#header-score").html(n.toLocaleString("de-DE")+" "+e),$("#action-button").html("Start!").removeClass("timing-mode")}else n=0,$("#header-score").html("timing...").removeClass("winning"),$("#action-button").html("Stop").addClass("timing-mode"),$("#flashcard-result").html("?"),$("#score-reaction").html(a),i=!0,start=(new Date).getTime();ga("send","event","Action Button","Clicked")}),$("#time-selection").on("click",".dropdown-menu li a ",function(){$("#time-selection > button").text($(this).attr("data-time")),o=$(this).attr("data-target"),ga("send","event","Time Select","Clicked")})});